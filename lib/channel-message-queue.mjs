...
export class ChannelMessageQueue extends Container {
    ...
    */
    shift(isReceived = false) {
        return Task.create('shift', this, { data: isReceived, logRunning: true }).queue(Message.prototype, async function (instance, isReceived) {
            ...
            if (channelMessage) {
                ...
                if (!(channelMessage instanceof Message)) {
                    return new Error(`message shifted from queue is not of type: ${Message.name}`);
                }
