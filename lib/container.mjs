...
export class Container {
    constructor() {
        ...
        Task.create(this, { data: callStack, priority: Priority.High }).run(null, async function (instance, callStack) {
    ...
    */
    setProperty(prop) {
        ...
        return Task.create(this, { data: prop, priority: Priority.High }).run(null, async function (instance, prop) {
    ...
    setReference(depInstance, type, namedInstance = null) {
        const vars = privateBag.get(this);
        vars.stack = (new Error()).stack;
        return Task.create(this, { data: { depInstance, namedInstance }, priority: Priority.High }).run(null, async function (instance, { depInstance, namedInstance }) {
            const vars = privateBag.get(instance);
            validateContainerClass(instance);
    ...
    getReference(type, namedInstance = null) {
        const vars = privateBag.get(this);
        vars.stack = (new Error()).stack;
        return Task.create(this, { data: { type, namedInstance } }).run(type, async function (instance, { type, namedInstance }) {
            const vars = privateBag.get(instance);
            validateContainerClass(instance);
            await validateCalledInClassContext(instance);
            if (namedInstance) {
    ...
    getProperty(propTemplate, type) {
        const vars = privateBag.get(this);
        vars.stack = (new Error()).stack;
        return Task.create(this, { data: { propTemplate, type }, priority: Priority.Low }).run(type, async function (instance, { propTemplate, type }) {
            const vars = privateBag.get(instance);
            validateContainerClass(instance);
            await validateCalledInClassContext(instance);
