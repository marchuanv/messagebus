...
const uuidMatch = /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/gi;
...
export class Container {
    ...
    */
    ...
    poll(callback) {
        const queueServiceId = setInterval.call(this, () => {
            setImmediate.call(this, async () => {
                try {
                    if ((await callback.call(this))) {
                        clearInterval.call(this, queueServiceId);
                    }
                } catch (error) {
                    console.error(error);
                }
    ...
    promise(callback) {
        return new Promise(async (resolve, reject) => {
            await callback.call(this, resolve, reject);
        });
    }
    /**
     * @param { Object } prop
    ...
    static async getReference(ctx, type, namedInstance = null) {
        return await queue({ context: ctx, namedInstance, type }, async ({ context, type, namedInstance }) => {
            ...
            if (namedInstance) {
                ...
                uuidMatch.lastIndex = -1;
                const instances = Object.keys(vars)
                    .filter(key => uuidMatch.test(key))
                    .map(key => vars[key]);
