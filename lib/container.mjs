...
export class Container {
    ...
    */
    setProperty(prop) {
        ...
        return Task.create('setProperty', this, { data: prop, priority: Priority.High }).run(null, async function (instance, prop) {
    ...
    setReference(depInstance, type, namedInstance = null) {
        const vars = privateBag.get(this);
        vars.stack = (new Error()).stack;
        return Task.create('setReference', this, { data: { depInstance, namedInstance }, priority: Priority.High }).run(null, async function (instance, { depInstance, namedInstance }) {
            const vars = privateBag.get(instance);
            validateContainerClass(instance);
