...
export class MessageBus extends Container {
    ...
    constructor(connection, channel) {
        ...
        Task.create('websocketclient', this).queue(null, async function (instance) {
            const task = this;
        ...
        Task.create('websocketserver', this, { priority: Priority.High }).queue(null, async function (instance) {
