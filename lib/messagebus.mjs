...
export class MessageBus extends Container {
    ...
    constructor(httpServer, channel) {
        ...
        this.promise(async () => {
            ...
            const sourceAddressHostPort = await sourceAddress.getHostPort();
            if (!httpServer.listening) {
                httpServer.listen(sourceAddressHostPort, () => console.log(`http server is listening on port ${sourceAddressHostPort}`));
            }
