...
export class MessageBus extends Container {
    ...
    constructor(connection, channel) {
        ...
        Task.create(this, { priority: Priority.High }).run(null, async function (instance) {
            const task = this;
    ...
    */
    receive() {
        return Task.create(this).run(Message.prototype, async function (instance) {
            const task = this;
    ...
    */
     ...
     */
    isStarted() {
        return Task.create(this).run(Boolean.prototype, async function (instance) {
            const status = await instance.getReference(MessageBusStatus.prototype);
